...
namespace INASOFT_3._0.Modelos
{
    class Productos
    {
        ...
        private double existencias_min;
        ...
        public double Existencias { get => existencias; set => existencias = value; }
        ...
        public double Existencias_min { get => existencias_min; set => existencias_min = value; }
